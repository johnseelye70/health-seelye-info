...
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS height_cm NUMERIC DEFAULT 178;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS current_weight_kg NUMERIC DEFAULT 80.0;
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS target_weight_kg NUMERIC DEFAULT 75.0;
