...
export const RecipeDetailModal: React.FC<RecipeDetailModalProps> = ({
  ...
  const [selectedMealSlot, setSelectedMealSlot] = useState<number>(1);
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-3xl my-auto p-6 sm:p-8 rounded-3xl bg-surface-100/95 border border-surface-border shadow-2xl backdrop-blur-xl text-zinc-100 max-h-[90vh] overflow-y-auto space-y-6"
      ...
      >
        ...
        {/* Modal Header */}
        <div className="space-y-3 pb-4 border-b border-surface-border pr-10">
        ...
        <div className="pt-4 border-t border-surface-border flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <button
            ...
            className="w-full sm:w-auto px-4 py-3 rounded-2xl bg-surface-200 hover:bg-surface-300 border border-surface-border text-xs font-bold text-zinc-200 flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer shadow-sm"
          >
            <Printer className="w-4 h-4 text-brand-400" />
            <span>Print Recipe (4x6 Card / Letter)</span>
          </button>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-4 py-3 rounded-2xl bg-surface-200 hover:bg-surface-300 border border-surface-border text-xs font-bold text-zinc-200 flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer"
            >
            ...
            {isSimple ? (
              <button
                ...
                className="flex-1 sm:flex-none px-6 py-3 rounded-2xl bg-gradient-to-r from-brand-500 to-accent-teal hover:from-brand-600 hover:to-accent-teal/90 text-zinc-950 font-bold text-xs shadow-glow transition-all active:scale-95 flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <div className="flex items-center gap-1 bg-surface-200 p-1 rounded-2xl border border-surface-border">
                {[1, 2, 3].map((slot) => (
                  <button
                    ...
                    className="px-3 py-2 rounded-xl bg-surface-300 hover:bg-brand-500 hover:text-zinc-950 text-brand-300 text-xs font-mono font-bold transition-all active:scale-95 cursor-pointer"
